...
func NewProtectServerAdapter(modulePath string) (*ProtectServerAdapter, error) {
	base, err := newPKCS11Adapter(modulePath, protectServerCapabilities)
	if err != nil {
		return nil, err
	}
...
// protectServerCapabilities is what ProtectToolkit-C 7.3.3 software emulation was
// measured to do.
var protectServerCapabilities = Capabilities{
